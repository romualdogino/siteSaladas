  ...
  return (
    <div className={clsx(styles.root, className)}>
      ...
      <div className={styles.wrap}>
        ...
        <p className={styles.content}><small>cliente: </small><strong>{post.nome}</strong></p>
        <p className={styles.content}><small>fone: </small> <strong>{post.fone}</strong></p>
        <p className={styles.content}><small>endereço: </small> <strong>{post.endereco}</strong></p>
        <p className={styles.content}><small>referência: </small> <strong>{post.ref}</strong></p>
        <p className={styles.content}><small>observações: </small> <strong>{post.obs}</strong></p>
        <p className={styles.content}><small>forma de pagamento: </small> <strong>{post.formaPagamento}</strong></p>
        <hr />
        <div className={styles.sides}>
          <div className={styles.left}><small>FOLHAS:  </small></div>
